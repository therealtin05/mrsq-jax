...
from MRSQ.envs.wrappers.pixels import PixelWrapper
from typing import Any, NamedTuple
import dm_env
import numpy as np
from MRSQ.envs.tasks import cheetah, walker, hopper, reacher, ball_in_cup, pendulum, fish
...
def make_dmc_env(task, seed, obs_type):
	"""
	Make a DMC env exactly like TDMPC2 (https://github.com/nicklashansen/mrsq/blob/main/mrsq/envs/dmcontrol.py).
